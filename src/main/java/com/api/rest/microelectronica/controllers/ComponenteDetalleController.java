...
public class ComponenteDetalleController {
    ...
    @ApiResponses(value = {
        	...
        	@ApiResponse(responseCode = "201", description = "Se ha Insertado el Detalle del Componente Correctamente", content = {
			...
			@ApiResponse(responseCode = "401", description = "No está autorizado para Insertar Detalle del Componente. Verificar Credenciales", content = @Content),
			@ApiResponse(responseCode = "403", description = "No se ha podido insertar Detalle del componente. El servidor ha denegado esta operación", content = @Content),
    ...
    @ApiResponses(value = {
            ...
            content = {@Content(mediaType = "application/json")}),
        	@ApiResponse(responseCode = "201", description = "Se ha Actualizado el Detalle del Componente Correctamente", content = {
					@Content(mediaType = "application/json") }),
			...
			@ApiResponse(responseCode = "401", description = "No está autorizado para Actualizar el  Detalle del Componente. Verificar Credenciales", content = @Content),
			@ApiResponse(responseCode = "403", description = "No se ha podido Actualizar el Detalle del componente. El servidor ha denegado esta operación", content = @Content),
			 @ApiResponse(responseCode = "404",
    ...
    @ApiResponses(value = {
            ...
            content = {@Content(mediaType = "application/json")}),
         	@ApiResponse(responseCode = "201", description = "Se ha Eliminado el Detalle del Componente Correctamente", content = {
					@Content(mediaType = "application/json") }),
			...
			@ApiResponse(responseCode = "401", description = "No está autorizado para Eliminar el  Detalle del Componente. Verificar Credenciales", content = @Content),
			@ApiResponse(responseCode = "403", description = "No se ha podido Eliminar el Detalle del componente. El servidor ha denegado esta operación", content = @Content),
			 @ApiResponse(responseCode = "404",
    ...
    @ApiResponses(value = {
            ...
            content = {@Content(mediaType = "application/json")}),
         	@ApiResponse(responseCode = "201", description = "Se ha Traído el Listado de Detalle del Componente Correctamente", content = {
					@Content(mediaType = "application/json") }),
			@ApiResponse(responseCode = "400", description = "No se pudo traer el Listado de Detalle del Componente. Comprobar la Solicitud", content = @Content),
			@ApiResponse(responseCode = "401", description = "No está autorizado para traer el Listado de Detalle del Componente. Verificar Credenciales", content = @Content),
			@ApiResponse(responseCode = "403", description = "No se ha podido traer el Listado de Detalle del Componente. El servidor ha denegado esta operación", content = @Content),
			 @ApiResponse(responseCode = "404",
